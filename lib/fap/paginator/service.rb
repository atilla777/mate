...
module FAP
  module Paginator
    class Service
      ...
      def initialize(scope, cursor: nil, direction: nil, limit: DEFAULT_PER_PAGE, skip_total: true, filter_params:)
        @scope = scope
        @cursor = cursor
        @direction = direction
        @limit = limit
      ...
      attr_reader :scope, :cursor, :direction, :limit, :skip_total, :paginator, :filter_params
