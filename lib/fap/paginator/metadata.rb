module Pagination
  class Metadata
    ...
    def initialize(paginator:, page:, limit:, skip_total:, cursor:, direction:, filter_params:, sort_params:)
      @paginator = paginator
      @page = page
      @limit = limit
    ...
    def params = { direction:, cursor:, per_page: limit, q: filter_params, sort: sort_params }

    private

    attr_reader :paginator, :page, :skip_total, :limit, :filter_params, :sort_params
