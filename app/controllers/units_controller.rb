...
class UnitsController < ApplicationController
  ...
  def new
    render turbo_stream: turbo_stream.update('record', Views::Unit::Edit.new(record:))
  end

  def show
    render turbo_stream: turbo_stream.update('record', Views::Unit::Show.new(record:))
  end
  ...
  def create
    ...
    if record.errors.empty?
      ...
      render(turbo_stream: turbo_stream.update(
        'record', Views::Unit::Edit.new(record:),
        method: :morph
        ),
